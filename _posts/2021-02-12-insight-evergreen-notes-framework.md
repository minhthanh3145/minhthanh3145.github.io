...
If the initial representation is inadequate, then go through each evergreen note and decompose it into other evergreen notes. The relationship between each new evergreen note and the remaining evergreen notes that make up the initial representation forms another representation of the problem. If this representation is still inadequate, then decompose the remaining initial evergreen notes. Rinse and repeat.
